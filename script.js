document.addEventListener('DOMContentLoaded', function() {
    ...
    // Weather Code to Background Class Mapping
...
//* -------------------- Weather code to icon/description mapping ---------------
    function getWeatherInfo(weatherCode) {
        const weatherCodes = {
            0: { description: 'Clear sky', icon: 'https://cdn.jsdelivr.net/gh/leonardosnt/mc-weather-icons/icons/clear.png' },
            1: { description: 'Mainly clear', icon: 'https://cdn.jsdelivr.net/gh/leonardosnt/mc-weather-icons/icons/partly-cloudy.png' },
            2: { description: 'Partly cloudy', icon: 'https://cdn.jsdelivr.net/gh/leonardosnt/mc-weather-icons/icons/partly-cloudy.png' },
            3: { description: 'Overcast', icon: 'https://cdn.jsdelivr.net/gh/leonardosnt/mc-weather-icons/icons/cloudy.png' },
            45: { description: 'Fog', icon: 'https://cdn.jsdelivr.net/gh/leonardosnt/mc-weather-icons/icons/fog.png' },
            48: { description: 'Depositing rime fog', icon: 'https://cdn.jsdelivr.net/gh/leonardosnt/mc-weather-icons/icons/fog.png' },
            51: { description: 'Light drizzle', icon: 'https://cdn.jsdelivr.net/gh/leonardosnt/mc-weather-icons/icons/rain.png' },
            53: { description: 'Moderate drizzle', icon: 'https://cdn.jsdelivr.net/gh/leonardosnt/mc-weather-icons/icons/rain.png' },
            55: { description: 'Dense drizzle', icon: 'https://cdn.jsdelivr.net/gh/leonardosnt/mc-weather-icons/icons/rain.png' },
            56: { description: 'Light freezing drizzle', icon: 'https://cdn.jsdelivr.net/gh/leonardosnt/mc-weather-icons/icons/sleet.png' },
            57: { description: 'Dense freezing drizzle', icon: 'https://cdn.jsdelivr.net/gh/leonardosnt/mc-weather-icons/icons/sleet.png' },
            61: { description: 'Slight rain', icon: 'https://cdn.jsdelivr.net/gh/leonardosnt/mc-weather-icons/icons/rain.png' },
            63: { description: 'Moderate rain', icon: 'https://cdn.jsdelivr.net/gh/leonardosnt/mc-weather-icons/icons/rain.png' },
            65: { description: 'Heavy rain', icon: 'https://cdn.jsdelivr.net/gh/leonardosnt/mc-weather-icons/icons/rain.png' },
            66: { description: 'Light freezing rain', icon: 'https://cdn.jsdelivr.net/gh/leonardosnt/mc-weather-icons/icons/sleet.png' },
            67: { description: 'Heavy freezing rain', icon: 'https://cdn.jsdelivr.net/gh/leonardosnt/mc-weather-icons/icons/sleet.png' },
            71: { description: 'Slight snowfall', icon: 'https://cdn.jsdelivr.net/gh/leonardosnt/mc-weather-icons/icons/snow.png' },
            73: { description: 'Moderate snowfall', icon: 'https://cdn.jsdelivr.net/gh/leonardosnt/mc-weather-icons/icons/snow.png' },
            75: { description: 'Heavy snowfall', icon: 'https://cdn.jsdelivr.net/gh/leonardosnt/mc-weather-icons/icons/snow.png' },
            77: { description: 'Snow grains', icon: 'https://cdn.jsdelivr.net/gh/leonardosnt/mc-weather-icons/icons/snow.png' },
            80: { description: 'Slight rain showers', icon: 'https://cdn.jsdelivr.net/gh/leonardosnt/mc-weather-icons/icons/rain.png' },
            81: { description: 'Moderate rain showers', icon: 'https://cdn.jsdelivr.net/gh/leonardosnt/mc-weather-icons/icons/rain.png' },
            82: { description: 'Violent rain showers', icon: 'https://cdn.jsdelivr.net/gh/leonardosnt/mc-weather-icons/icons/rain.png' },
            85: { description: 'Slight snow showers', icon: 'https://cdn.jsdelivr.net/gh/leonardosnt/mc-weather-icons/icons/snow.png' },
            86: { description: 'Heavy snow showers', icon: 'https://cdn.jsdelivr.net/gh/leonardosnt/mc-weather-icons/icons/snow.png' },
            95: { description: 'Thunderstorm', icon: 'https://cdn.jsdelivr.net/gh/leonardosnt/mc-weather-icons/icons/thunderstorm.png' },
            96: { description: 'Thunderstorm with slight hail', icon: 'https://cdn.jsdelivr.net/gh/leonardosnt/mc-weather-icons/icons/thunderstorm.png' },
            99: { description: 'Thunderstorm with heavy hail', icon: 'https://cdn.jsdelivr.net/gh/leonardosnt/mc-weather-icons/icons/thunderstorm.png' }
        };
        
        return weatherCodes[weatherCode] || { description: 'Unknown', icon: 'https://cdn.jsdelivr.net/gh/leonardosnt/mc-weather-icons/icons/unknown.png' };
    }
